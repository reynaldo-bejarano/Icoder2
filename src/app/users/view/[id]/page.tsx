        ...
        <div className="grid grid-cols-4 gap-4 w-full text-sm">
          ...
          <div className=" bg-slate-800 py-2 px-4 col-span-4 flex gap-4 items-center justify-between ">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() =>
                  navigation.push(`/users/edit/${user?.identification}`)
                }
              ...
              >
                ...
                <span className="text-md">Editar</span>
              </button>
              <button className=" flex items-center  bg-red-600 py-1 px-2 text-slate-100 rounded-md md:col-span-1 text-center ">
                Desactivar
              </button>
            </div>
          </div>
          ...
          <div className="w-full bg-slate-200 p-4 col-span-4 md:col-span-2">
            ...
            <div className="py-1 grid grid-cols-3 gap-4 w-full ">
              <div className="grid gap-1">
                ...
                <span className="w-full px-2 bg-slate-100">
                  {user?.identification || "Cargando"}
                </span>
              </div>
              <div className="grid gap-1">
                <label>Edad</label>
                <span className="w-full px-2 bg-slate-100">
                  {(user?.birth && calcularEdad(`${user?.birth}`)) ||
                    "Cargando"}
                </span>
              </div>
              <div className="grid gap-1">
            ...
            <div className="py-1 grid grid-cols-3 gap-4 w-full ">
              ...
              <div className="grid gap-1">
                ...
                <span className="w-full px-2 bg-slate-100">
                  {user?.lastname1 || "Cargando"}
                </span>
              </div>
              <div className="grid gap-1">
                <label>Segundo Apellido</label>
                <span className="w-full px-2 bg-slate-100">
                  {user?.lastname2 || "Cargando"}
                </span>
              </div>
            </div>
            <div className="py-1 grid grid-cols-3 gap-4 w-full">
          ...
          <div className="w-full bg-slate-200 p-4 col-span-4 md:col-span-2">
            ...
            <div className="grid grid-cols-2 py-5 gap-2">
              <div className="grid gap-5 col-span-1">
                <div className=" grid w-full">
                  <div className="grid grid-cols-4 gap-2 ">
                    ...
                    <span className="w-full col-span-3 px-2 bg-slate-100 capitalize">
                      {user?.address.provincia_id || "Cargando"}
                    </span>
                  </div>
                </div>
                <div className="grid w-full">
              ...
              <div className="grid col-span-1">
                <span className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg">
                  {user?.address.description || "Cargando..."}
                </span>
              </div>
            </div>
          </div>
