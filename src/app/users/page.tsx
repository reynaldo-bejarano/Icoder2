  ...
  return (
    <div className="w-full h-screen ">
      ...
      <div className="container w-full mx-auto ">
        <div className="bg-gray-800  text-gray-100 text-center"></div>
          ...
          <table className="w-full text-sm grid">
            ...
            <tbody>
              {users.map<any>((item: any) => {
                return (
                  <tr
                    className="text-slate-900 grid grid-cols-8 text-left gap-2 border py-2 capitalize"
                    key={item._id}
                  >
                    ...
                    <td className="col-span-1 pl-10 lowercase">
                      {item?.email}
                    </td>
