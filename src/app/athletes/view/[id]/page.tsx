...
const ViewAthlete = () => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const resCanton = await axios.get(`/api/auth/cantones/view/${athlete?.address?.canton_id}`)
        setCantonDataByID(resCanton.data.cantonDataByID[0]);
        const resDistrito = await axios.get(`/api/auth/distritos/view/${athlete?.address?.distrito_id}`)
          ...
          <div className='w-full bg-slate-200 p-4 col-span-4 md:col-span-2'>
            ...
            <div className='py-1 grid grid-cols-3 gap-4 w-full '>
              <div className='grid gap-1'>
                ...
                <span className='w-full px-2 bg-slate-100'>{athlete?.identification || "Cargando"}</span>
              ...
              <div className='grid gap-1'>
                <label >Género</label>
                <span className='w-full col-span-3 px-2 bg-slate-100 capitalize'>{athlete?.genre || "Cargando"}</span>
              </div>
            </div>
            <div className='py-1 grid grid-cols-3 gap-4 w-full '>
              <div className='grid gap-1'>
                <label >Nombre</label>
                <span className='w-full px-2 bg-slate-100'>{athlete?.name || "Cargando"}</span>

              </div>
              <div className='grid gap-1'>
                <label>Primer Apellido</label>
                <span className='w-full px-2 bg-slate-100'>{athlete?.lastname1 || "Cargando"}</span>
              </div>
              <div className='grid gap-1'>
                <label >Segundo Apellido</label>
                <span className='w-full px-2 bg-slate-100'>{athlete?.lastname2 || "Cargando"}</span>
              </div>
            </div>
            <div className='py-1 grid grid-cols-3 gap-4 w-full'>
              <div className='grid gap-1 col-span-2'>
                <label >Correo electrónico</label>
                <span className='w-full px-2 bg-slate-100'>{athlete?.email || "Cargando"}</span>
              </div>
              <div className='grid gap-1 col-span-1'>
                <label>Teléfono</label>
                <span className='w-full px-2 bg-slate-100'>{athlete?.phone || "Cargando"}</span>
              </div>
            </div>
          </div>
          {/* Datos personales*/}
            ...
            <div className='grid gap-5 py-5'>
              <div className=' grid w-full'>
                <div className='grid grid-cols-4 gap-2 '>
                  ...
                  <span className='w-full col-span-3 px-2 bg-slate-100 capitalize'>{athlete?.address.provincia_id || "Cargando"}</span>
                </div>
              </div>
              <div className='grid w-full'>
                <div className='grid grid-cols-4 gap-2 '>
            ...
            <div className='grid gap-5 py-5'>
              <div className=' grid w-full'>
                <div className='grid grid-cols-4 gap-2 '>
                  ...
                  <span className='w-full col-span-3 px-2 bg-slate-100'>{sportDataByID?.name || "Cargando..."}</span>
              ...
              <div className='grid w-full'>
                <div className='grid grid-cols-4 gap-2 '>
                  ...
                  <span className='w-full col-span-3 px-2 capitalize bg-slate-100'>{modalityDataByID?.name || "Cargando..."}</span>
              ...
              <div className=' grid w-full'>
                <div className='grid grid-cols-4 gap-2 '>
                  ...
                  <span className='w-full col-span-3 px-2 bg-slate-100'>{athlete?.activity.intensity || "Cargando"}</span>
