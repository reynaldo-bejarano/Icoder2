        ...
        <>
            {pathname !== "/login"
                ...
                <div className="flex md:flex-row-reverse flex-wrap bg-gray-100">
                    <div className="w-full p-4 px-8  md:flex  justify-between bg-gray-900 z-10">
                        <Image
                            src={"/logoICODER.png"}
                            width={"256"}
                            height={"36"}
                    ...
                    {/*Main Content*/}
                    <div className="w-full md:w-[84%] bg-gray-100">
                    ...
                    {/*Sidebar*/}
                    <div className="w-full  md:w-[15%] bg-gray-900 md:bg-gray-900 px-2 text-center fixed bottom-0 md:pt-20 md:top-0 md:left-0 h-16 md:h-screen md:border-r-4 md:border-gray-600 flex justify-center">
