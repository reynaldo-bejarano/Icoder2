...
const ModalRegisterAthlete = () => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        ...
        try {
            const res = await axios.post("/api/auth/athletes", dataForm)
            console.log(res)
            dispatch(change())
                        ...
                        <div className="w-full bg-slate-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="w-full sm:flex sm:items-start">
                                ...
                                <div className="w-full text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 className="text-lg font-medium text-gray-900">Agregar deportista</h3>
...
export default ModalRegisterAthlete